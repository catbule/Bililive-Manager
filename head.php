...
h2{margin-bottom:15px;font-size:30px;font-weight:300;color:#e05d6f}
...
.foot{position:relative;top:90px;margin:15px 15px 0;font-size:12px;color:#4eb0f8}
pre{background:#3498DB;color:#ffffff;padding:15px 20px;margin:25px -15px -15px;line-height:1.4em;font-size:14px;text-align:left;word-break:break-all;white-space:pre-wrap}</style>
</head>
<body>
